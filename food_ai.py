...
class GeminiFoodAnalyzer:
    ...
    PROMPT = (
        ...
        "- **붉은 양념 볶음/구이는 '고기 종류'를 반드시 구분해라(닭/돼지/소는 칼로리가 다르다).** "
        "닭갈비·닭볶음탕(닭: 뼈·닭다리살, 주로 양배추·떡 동반)과 제육볶음(돼지: 삼겹/앞다리 얇은 저민 고기)은 "
        "양념색이 비슷해도 다른 요리다. 뼈 유무·고기 결·부재료로 판별하고, 확실치 않으면 고기 종류를 추정해 명시해라.\n"
